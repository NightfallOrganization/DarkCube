...
import eu.darkcube.system.bukkit.inventoryapi.item.AbstractItemBuilder;
import eu.darkcube.system.bukkit.inventoryapi.item.ItemBuilder;
import eu.darkcube.system.bukkit.inventoryapi.item.meta.*;
import eu.darkcube.system.bukkit.inventoryapi.item.meta.SkullBuilderMeta.UserProfile;
import eu.darkcube.system.bukkit.inventoryapi.item.meta.SkullBuilderMeta.UserProfile.Texture;
        ...
        if (meta != null) {
            ...
            if (meta.getAttributeModifiers() != null) {
                meta.getAttributeModifiers().forEach((attribute, attributeModifier) -> {
                    eu.darkcube.system.bukkit.inventoryapi.item.attribute.Attribute sa = new eu.darkcube.system.bukkit.inventoryapi.item.attribute.Attribute(new Key(attribute
                            .key()
                            .namespace(), attribute.key().value()));
                    eu.darkcube.system.bukkit.inventoryapi.item.attribute.Operation so = eu.darkcube.system.bukkit.inventoryapi.item.attribute.Operation.values()[attributeModifier
                            .getOperation()
                            .ordinal()];
                    eu.darkcube.system.bukkit.inventoryapi.item.EquipmentSlot ses = attributeModifier.getSlot() == null ? null : eu.darkcube.system.bukkit.inventoryapi.item.EquipmentSlot.valueOf(attributeModifier
                            .getSlot()
                            .name());
                    attributeModifier(sa, new eu.darkcube.system.bukkit.inventoryapi.item.attribute.AttributeModifier(attributeModifier.getUniqueId(), attributeModifier.getName(), attributeModifier.getAmount(), so, ses));
                });
