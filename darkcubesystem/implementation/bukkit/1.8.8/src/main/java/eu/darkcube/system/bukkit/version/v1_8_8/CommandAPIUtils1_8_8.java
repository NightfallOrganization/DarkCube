...
import eu.darkcube.system.bukkit.commandapi.InternalCommandTabExecutor;
...
public class CommandAPIUtils1_8_8 extends BukkitCommandAPIUtils {
    private final TabExecutor executor = new InternalCommandTabExecutor();

    public CommandAPIUtils1_8_8() {
    }
