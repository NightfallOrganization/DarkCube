...
import eu.darkcube.system.bukkit.version.v1_20_2.util.WorkbenchUtil1_20_2;
...
public class VersionImpl extends BukkitVersionImpl {
    public VersionImpl() {
        this.commandApiUtils = new CommandAPIUtils1_20_2();
        this.itemProvider = new ItemProvider1_20_2();
        this.classifier = "1_20_2";
    ...
    @Override public void enabled(DarkCubeSystemBukkit system) {
        ...
        ((CommandAPIUtils1_20_2) commandApiUtils).enabled(system);
    }
}
