...
public enum Language {
    ...
    public static Style lastStyle(Component c) {
        return c.children().isEmpty() ? c.style() : c.children().get(c.children().size() - 1).style();
    }
    ...
    public Component getMessage(String key, Object... replacements) {
        ...
        if (this.bundle.containsKey(key)) {
            String formatted = String.format(this.locale, this.bundle.getObject(key).toString(), replacements);
            formatted = eu.darkcube.system.util.ChatColorUtil.translateAlternateColorCodes('&', formatted);
            ...
            for (int i = 0; i < components.size(); i++) {
                ...
                if (s.length == 2) {
                    ...
                    String str = LegacyComponentSerializer.legacySection().serialize(Component.text(" ").style(lastStyle(o)));
                    str = str.replace(" ", "");
            ...
            if (components.isEmpty()) {
                ...
                String str = LegacyComponentSerializer.legacySection().serialize(Component.text(" ").style(lastStyle(c)));
                str = str.replace(" ", "");
            ...
            return LegacyComponentSerializer
                    .legacySection()
                    .deserialize(key + '[' + String.join(", ", Arrays
                            .stream(replacements)
                            .map(String::valueOf)
                            .toArray(String[]::new)) + ']');
        }
    ...
    private static class Bundle extends ResourceBundle {
        ...
        @Override public @NotNull Set<String> handleKeySet() {
