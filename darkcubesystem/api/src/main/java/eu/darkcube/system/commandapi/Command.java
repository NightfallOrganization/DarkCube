...
public abstract class Command implements Taber {
    ...
    public final void onCommand(CommandSender sender, String[] args, String start) {
        ...
        } else sender.sendMessage(VersionSupport.version().commandApi().getSpigotUnknownCommandMessage());
    }
    ...
    public final String getUsage(CommandSender sender, String start) {
        if (hasPermission(sender)) {
            ...
            if (hasSubCommands()) {
                ...
                if (niceCommandName.length() > 0)
                    niceCommandName = Character.toString(niceCommandName.charAt(0)).toUpperCase() + niceCommandName.substring(1);
                builder
                        .append(this.instance.prefix)
                        .append("§3§lCommand Beschreibung - §b")
                        .append(niceCommandName)
                        .append('\n')
                        .append(this.instance.prefix)
                        .append("§b> §7")
                        .append(this.beschreibung);
        ...
        return VersionSupport.version().commandApi().getSpigotUnknownCommandMessage();
    }
