...
public class ItemBuilder_1_8_8 extends AbstractItemBuilder {
	...
	public ItemBuilder_1_8_8(ItemStack item) {
	...
	public AbstractItemBuilder clone() {
		AbstractItemBuilder builder =
				new ItemBuilder_1_8_8().amount(amount).damage(damage).displayname(displayname)
