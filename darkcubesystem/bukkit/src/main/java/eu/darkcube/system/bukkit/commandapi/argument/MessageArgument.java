...
public class MessageArgument implements ArgumentType<MessageArgument.Message> {
    ...
    public static String getMessage(CommandContext<CommandSource> context, String name) {
        return context.getArgument(name, Message.class).getText();
    }

    @Override public Message parse(StringReader reader) throws CommandSyntaxException {
