 ...
 * @version 1.1
 */
@Api public final class ReflectionUtils {
     ...
     */
    @Api public static <T> Constructor<T> getConstructor(Class<T> clazz, Class<?>... parameterTypes) {
        try {
     ...
     */
    @Api public static <T> Constructor<T> getConstructor(String className, PackageType packageType, Class<?>... parameterTypes) {
     ...
     */
    @Api public static <T> T instantiateObject(Constructor<T> constructor, Object... arguments) {
        try {
     ...
     */
    @Api public static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        try {
     ...
     */
    @Api public static Method getMethod(String className, PackageType packageType, String methodName, Class<?>... parameterTypes) {
     ...
     */
    @Api public static Class<?> getClass(String className, PackageType packageType) {
     ...
     * @return the class
     */
    @Api public static Class<?> getClass(String className) {
        try {
     ...
     */
    @Api public static Object invokeMethod(Object instance, Method method, Object... arguments) {
        try {
     ...
     *                             accessible
     */
    @Api public static Field getField(Class<?> clazz, boolean declared, String fieldName) {
        try {
     ...
     */
    @Api public static Field getField(String className, PackageType packageType, boolean declared, String fieldName) {
     ...
     * @see #getField(Class, boolean, String)
     */
    @Api public static Object getValue(Object instance, Class<?> clazz, boolean declared, String fieldName) {
        try {
     ...
     *                             <br><b>SecurityException</b> If the desired field cannot be made
     *                             accessible
     *                             <br><b>ClassCastException</b> If the value is not of instance {@code valueClass}
     * @see #getField(Class, boolean, String)
     */
    @Api public static <T> T getValue(Object instance, Class<?> clazz, boolean declared, String fieldName, Class<T> valueClass) {
        try {
            return valueClass.cast(ReflectionUtils.getField(clazz, declared, fieldName).get(instance));
     ...
     */
    @Api public static Object getValue(Object instance, Field field) {
        try {
     ...
     */
    @Api public static Object getValue(Object instance, String className, boolean declared, String fieldName) {
        return ReflectionUtils.getValue(instance, ReflectionUtils.getField(ReflectionUtils.getClass(className), declared, fieldName));
    }
     ...
     */
    @Api public static Object getValue(Object instance, String className, PackageType packageType, boolean declared, String fieldName) {
     ...
     * @see #getValue(Object, Class, boolean, String)
     */
    @Api public static Object getValue(Object instance, boolean declared, String fieldName) {
     ...
     * @see #getField(Class, boolean, String)
     */
    @Api public static void setValue(Object instance, Class<?> clazz, boolean declared, String fieldName, Object value) {
        try {
     ...
     */
    @Api public static void setValue(Object instance, Field field, Object value) {
        try {
     ...
     * @see #setValue(Object, Class, boolean, String, Object)
     */
    @Api public static void setValue(Object instance, boolean declared, String fieldName, Object value) {
    ...
    public enum PackageType {
         ...
         */
        @Api public static String getServerVersion() {
         ...
         */
        @Api @SuppressWarnings("unchecked") public <T> Class<T> getClass(String className) {
            try {
     ...
     * <br>{@inheritDoc}
     */
    @Api public static class ReflectionException extends RuntimeException {

        /**
         * {@inheritDoc}
         */
        @Api public ReflectionException() {
            super();
        }
         ...
         * {@inheritDoc}
         */
        @Api public ReflectionException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
         ...
         * {@inheritDoc}
         */
        @Api public ReflectionException(String message, Throwable cause) {
            super(message, cause);
        }
         ...
         * {@inheritDoc}
         */
        @Api public ReflectionException(String message) {
            super(message);
        }
         ...
         * {@inheritDoc}
         */
        @Api public ReflectionException(Throwable cause) {
            super(cause);
        }
