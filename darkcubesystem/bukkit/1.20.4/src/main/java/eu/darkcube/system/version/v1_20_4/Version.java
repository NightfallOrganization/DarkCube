...
import eu.darkcube.system.version.v1_20_4.util.WorkbenchUtil1_20_4;
...
public class Version extends BukkitVersion {
    ...
    @Override public void init() {
        super.init();
        this.commandApi = new CommandAPI1_20_4();
        this.itemProvider = new ItemProvider1_20_4();
        this.classifier = "1_20_4";
        ...
        provider.register(WorkbenchUtil.class, new WorkbenchUtil1_20_4());
    }
    ...
    @Override public void enabled(DarkCubeSystem system) {
        ...
        ((CommandAPI1_20_4) commandApi).enabled(system);
    }
}
