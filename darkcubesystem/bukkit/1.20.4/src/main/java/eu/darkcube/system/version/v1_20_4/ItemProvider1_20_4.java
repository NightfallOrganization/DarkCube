...
public class ItemProvider1_20_4 implements ItemProvider {
    @Override public ItemBuilder item(Material material) {
        return new ItemBuilder1_20_4().material(material);
    }

    @Override public ItemBuilder item(ItemStack item) {
        return new ItemBuilder1_20_4(item);
    }

    @Override public ItemBuilder item(JsonElement json) {
        return ItemBuilder1_20_4.deserialize(json);
    }
