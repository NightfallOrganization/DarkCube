...
public class ItemBuilder1_19_3 extends AbstractItemBuilder {
    ...
    public ItemBuilder1_19_3() {
        this.item = null;
    }

    public ItemBuilder1_19_3(ItemStack item) {
    ...
    public AbstractItemBuilder clone() {
        return new ItemBuilder1_19_3(build());
    }
}
