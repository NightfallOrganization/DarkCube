...
public class ItemProvider1_19_3 implements eu.darkcube.system.inventoryapi.item.ItemProvider {
    @Override
    public eu.darkcube.system.inventoryapi.item.ItemBuilder item(Material material) {
        return new ItemBuilder1_19_3().material(material);
    }

    @Override
    public eu.darkcube.system.inventoryapi.item.ItemBuilder item(ItemStack item) {
        return new ItemBuilder1_19_3(item);
    }
