...
public final class ReflectionUtils {
	...
	public static Constructor<?> getConstructor(Class<?> clazz, Class<?>... parameterTypes) {
		try {
			...
			for (Constructor<?> constructor : clazz.getConstructors()) {
				if (!DataType.compare(DataType.getPrimitive(constructor.getParameterTypes()),
						primitiveTypes)) {
					continue;
				}
				return constructor;
	 ...
	 */
	public static Constructor<?> getConstructor(String className, PackageType packageType,
	 ...
	 * be found
	 */
	public static <T> T instantiateObject(Class<? extends T> clazz, Object... arguments) {
		try {
			return clazz.cast(
					ReflectionUtils.getConstructor(clazz, DataType.getPrimitive(arguments))
	 ...
	 * @throws ReflectionException If you cannot create an instance of the desired target class due
	 * to certain circumstances<br> If the desired constructor cannot be accessed due to certain
	 * circumstances<br> If the types of the arguments do not match the parameter types of the
	 * constructor (this should not occur since it searches for a constructor with the types of the
	 * arguments)<br> If the desired constructor cannot be invoked<br> If the desired constructor
	 * with the specified arguments cannot be found<br> If the desired target class with the
	 * specified name and package cannot be found<br>
	 * @see #getClass(String, PackageType)
	 * @see #instantiateObject(Class, Object...)
	 */
	public static Object instantiateObject(String className, PackageType packageType,
			Object... arguments) {
	...
	public static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
		try {
			...
			for (Method method : clazz.getMethods()) {
				if (!method.getName().equals(methodName) || !DataType.compare(
						DataType.getPrimitive(method.getParameterTypes()), primitiveTypes)) {
					continue;
				}
				return method;
			}
	...
	public static Object invokeMethod(Object instance, String methodName, Object... arguments) {
		try {
			return ReflectionUtils.getMethod(instance.getClass(), methodName,
	...
	public static Object invokeMethod(Object instance, Class<?> clazz, String methodName,
			Object... arguments) {
		try {
			return ReflectionUtils.getMethod(clazz, methodName, DataType.getPrimitive(arguments))
	 ...
	 */
	public static Object invokeMethod(Object instance, String className, PackageType packageType,
			String methodName, Object... arguments) {
		return ReflectionUtils.invokeMethod(instance, packageType.getClass(className), methodName,
				arguments);
	}
	...
	public enum DataType {
		...
		public static boolean compare(Class<?>[] primary, Class<?>[] secondary) {
			...
			for (int index = 0; index < primary.length; index++) {
				...
				if (primaryClass.equals(secondaryClass) || primaryClass.isAssignableFrom(
						secondaryClass)) {
					continue;
				}
				return false;
