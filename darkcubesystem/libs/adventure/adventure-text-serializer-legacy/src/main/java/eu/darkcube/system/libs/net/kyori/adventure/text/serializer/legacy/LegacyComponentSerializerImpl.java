...
import eu.darkcube.system.libs.net.kyori.adventure.text.TextReplacementConfig;
...
import eu.darkcube.system.libs.net.kyori.adventure.text.flattener.FlattenerListener;
import eu.darkcube.system.libs.net.kyori.adventure.text.format.*;
...
final class LegacyComponentSerializerImpl implements LegacyComponentSerializer {
    ...
    static final class BuilderImpl implements Builder {
        private char character = SECTION_CHAR;
        private char hexCharacter = HEX_CHAR;
...
//            if (!text.isEmpty()) { // This blocks empty styles from being serialized
