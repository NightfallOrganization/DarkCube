...
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.findConstructor;
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.findCraftClass;
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.findEnum;
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.findField;
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.findMcClass;
...
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.findSetterOf;
...
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.needClass;
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.needField;
import static eu.darkcube.system.libs.net.kyori.adventure.platform.bukkit.MinecraftReflection.searchMethod;
...
class CraftBukkitFacet<V extends CommandSender> extends FacetBase<V> {
  ...
  private interface PartialEntitySound extends Facet.EntitySound<Player, Object> {
    ...
    @Override
    default Object createForSelf(final Player viewer, final eu.darkcube.system.libs.net.kyori.adventure.sound.@NotNull Sound sound) {
      return this.createForEntity(sound, viewer);
    }

    @Override
    default Object createForEmitter(final eu.darkcube.system.libs.net.kyori.adventure.sound.@NotNull Sound sound, final eu.darkcube.system.libs.net.kyori.adventure.sound.Sound.@NotNull Emitter emitter) {
      final Entity entity;
    ...
    default Object toVanilla(final eu.darkcube.system.libs.net.kyori.adventure.sound.Sound.Source source) throws Throwable {
      ...
      return MC_SOUND_SOURCE_BY_NAME.get(
		      eu.darkcube.system.libs.net.kyori.adventure.sound.Sound.Source.NAMES.key(source));
    }

    Object createForEntity(eu.darkcube.system.libs.net.kyori.adventure.sound.Sound sound, Entity entity);
  }
  ...
  static class EntitySound_1_19_3 extends PacketFacet<Player> implements PartialEntitySound {
    ...
    @Override
    public Object createForEntity(final eu.darkcube.system.libs.net.kyori.adventure.sound.Sound sound, final Entity entity) {
      try {
  ...
  protected static abstract class AbstractBook extends PacketFacet<Player> implements Facet.Book<Player, Object, ItemStack> {
    ...
    public String createMessage(final @NotNull Player viewer, final @NotNull Component message) {
      return BukkitComponentSerializer.gson().serialize(message);
    }
