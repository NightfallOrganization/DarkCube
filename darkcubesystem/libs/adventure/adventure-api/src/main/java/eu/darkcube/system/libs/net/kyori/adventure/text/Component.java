...
import eu.darkcube.system.libs.net.kyori.adventure.text.format.StyleGetter;
import eu.darkcube.system.libs.net.kyori.adventure.text.format.StyleSetter;
...
import eu.darkcube.system.libs.net.kyori.adventure.util.ForwardingIterator;
import eu.darkcube.system.libs.net.kyori.adventure.util.IntFunction2;
import eu.darkcube.system.libs.net.kyori.adventure.util.MonkeyBars;
...
public interface Component extends ComponentBuilderApplicable, ComponentLike, Examinable,
                                   HoverEventSource<Component>, StyleGetter,
