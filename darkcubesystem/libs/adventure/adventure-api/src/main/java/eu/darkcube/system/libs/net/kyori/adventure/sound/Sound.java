...
public interface Sound extends Examinable {
   ...
   *
   * @see Audience#playSound(Sound, Emitter)
   * @since 4.8.0
   */
  interface Emitter {
    /**
     ...
     *
     * <p>When used with {@link Audience#playSound(Sound, Emitter)}, the sound will be emitted from the recipient of the sound.</p>
     *
     * @return the emitter
     * @since 4.8.0
     */
