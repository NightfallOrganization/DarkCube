...
public class FacetAudience<V> implements Audience, Closeable {
  ...
  @Override
  public void playSound(final @NotNull Sound original) {
  ...
  @Override
  public void playSound(final @NotNull Sound original, final double x, final double y, final double z) {
    if (this.sound == null) return;
  ...
  @Override
  public void openBook(final @NotNull Book original) {
  ...
  @Override
  public void showTitle(final @NotNull Title original) {
