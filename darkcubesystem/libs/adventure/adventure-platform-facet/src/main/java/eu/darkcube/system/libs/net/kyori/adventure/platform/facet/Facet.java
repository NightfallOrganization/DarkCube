...
import static eu.darkcube.system.libs.net.kyori.adventure.platform.facet.Knob.logMessage;
...
public interface Facet<V> {
  ...
  interface Sound<V, P> extends Position<V, P> {
     ...
     * @since 4.0.0
     */
    void playSound(final @NotNull V viewer, final eu.darkcube.system.libs.net.kyori.adventure.sound.@NotNull Sound sound, final @NotNull P position);
  ...
  interface EntitySound<V, M> extends Facet<V> {
     ...
     * @since 4.0.0
     */
    M createForSelf(final V viewer, final eu.darkcube.system.libs.net.kyori.adventure.sound.@NotNull Sound sound);
     ...
     * @since 4.0.0
     */
    M createForEmitter(final eu.darkcube.system.libs.net.kyori.adventure.sound.@NotNull Sound sound, final eu.darkcube.system.libs.net.kyori.adventure.sound.Sound.@NotNull Emitter emitter);
   ...
   * @since 4.0.0
   */
  interface BossBar<V> extends eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Listener, Closeable {
     ...
     * @since 4.0.0
     */
    default void bossBarInitialized(final eu.darkcube.system.libs.net.kyori.adventure.bossbar.@NotNull BossBar bar) {
  ...
  interface BossBarPacket<V> extends BossBar<V> {
     ...
     * @since 4.0.0
     */
    default int createColor(final eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.@NotNull Color color) {
      if (color == eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Color.PURPLE) {
        return 5;
      } else if (color == eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Color.PINK) {
        return 0;
     ...
     * @since 4.0.0
     */
    default int createOverlay(final eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.@NotNull Overlay overlay) {
     ...
     * @since 4.0.0
     */
    default byte createFlag(final byte flagBit, final @NotNull Set<eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Flag> flagsAdded, final @NotNull Set<eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Flag> flagsRemoved) {
      byte bit = flagBit;
      for (final eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.@NotNull Flag flag : flagsAdded) {
      ...
      for (final eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.@NotNull Flag flag : flagsRemoved) {
        if (flag == eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Flag.DARKEN_SCREEN) {
          bit &= ~1;
        } else if (flag == eu.darkcube.system.libs.net.kyori.adventure.bossbar.BossBar.Flag.PLAY_BOSS_MUSIC) {
          bit &= ~(1 << 1);
  ...
  interface BossBarEntity<V, P> extends BossBar<V>, FakeEntity<V, P> {
    ...
    @Override
    default void bossBarProgressChanged(final eu.darkcube.system.libs.net.kyori.adventure.bossbar.@NotNull BossBar bar, final float oldProgress, final float newProgress) {
      this.health(newProgress);
    }

    @Override
    default void bossBarNameChanged(final eu.darkcube.system.libs.net.kyori.adventure.bossbar.@NotNull BossBar bar, final @NotNull Component oldName, final @NotNull Component newName) {
      this.name(newName);
    }
  ...
  interface Pointers<V> extends Facet<V> {
     ...
     * @since 4.0.0
     */
    void contributePointers(final V viewer, final eu.darkcube.system.libs.net.kyori.adventure.pointer.Pointers.Builder builder);
  }
}
