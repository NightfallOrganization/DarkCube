...
public class RequiredArgumentBuilder<S, T>
	...
	public static <S, T> RequiredArgumentBuilder<S, T> argument(final String name,
	...
	public ArgumentCommandNode<S, T> build() {
		final ArgumentCommandNode<S, T> result =
				new ArgumentCommandNode<>(getName(), getType(), getCommand(), getRequirement(),
