...
public final class CloudNetMySQLDatabaseModule extends NodeCloudNetModule {
	...
	public static final Type TYPE = new TypeToken<List<MySQLConnectionEndpoint>>() {}.getType();
	...
	public void initConfig() {
		...
		this.getConfig().get("addresses", TYPE,
				Collections.singletonList(new MySQLConnectionEndpoint(false, "CloudNet",
	...
	public void registerDatabaseProvider() {
		this.getRegistry().registerService(AbstractDatabaseProvider.class,
	...
	public void unregisterDatabaseProvider() {
		this.getRegistry().unregisterService(AbstractDatabaseProvider.class,
				this.getConfig().getString("database"));
	}
}
