...
public class NodePServer implements PServer {
	...
	public NodePServer(UniqueId id, boolean privateServer, boolean temporary, Collection<UUID> owners,
			String serverName, String taskName, ServiceConfiguration conf) {
...
//	}
	...
	public void createSerializable() {
		this.serializable = new PServerSerializable(id, getOnlinePlayers(), state, privateServer, temporary, startedAt,
				owners, taskName, serverName);
	}
