...
public interface PServerExecutor {
     ...
     */
    @NotNull
    CompletableFuture<@NotNull Boolean> start();
     ...
     */
    @NotNull
    CompletableFuture<@NotNull Boolean> accessLevel(@NotNull AccessLevel level);
     ...
     */
    @NotNull
    CompletableFuture<@NotNull Boolean> addOwner(UUID uuid);
     ...
     */
    @NotNull
    CompletableFuture<@NotNull Boolean> removeOwner(UUID uuid);

    /**
     * @return a new {@link PServerSnapshot} for this pserver
     */
    @NotNull
    CompletableFuture<@NotNull PServerSnapshot> createSnapshot();
     ...
     */
    @NotNull
    CompletableFuture<@NotNull Boolean> connectPlayer(UUID player);
     ...
     */
    @NotNull
    CompletableFuture<@NotNull State> state();

    /**
     * @return the pserver type
     */
    @NotNull
    CompletableFuture<@NotNull Type> type();
     ...
     */
    @NotNull
    CompletableFuture<@Nullable String> serverName();

    /**
     * @return an unmodifiable collection of the owners of this pserver
     */
    @NotNull
    CompletableFuture<@NotNull @Unmodifiable Collection<@NotNull UUID>> owners();
    ...
    @ApiStatus.Internal
    @NotNull
    CompletableFuture<@Nullable String> taskName();
