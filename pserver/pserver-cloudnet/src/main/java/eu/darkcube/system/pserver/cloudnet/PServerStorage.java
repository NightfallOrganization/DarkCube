...
public class PServerStorage implements PServerPersistentDataStorage {
    ...
    public PServerStorage(NodePServerProvider provider, NodePServerExecutor executor) {
        ...
        storage.loadFromJsonObject(provider.pserverData().get(pserver.toString()));
    ...
    public Document getDef(Key key, JsonElement def) {
    ...
    @Override
    public @NotNull CompletableFuture<@NotNull @Unmodifiable Collection<Key>> keysAsync() {
    ...
    @Override
    public @NotNull CompletableFuture<Boolean> hasAsync(@NotNull Key key) {
    ...
    @Override
    public @NotNull CompletableFuture<Void> loadFromJsonDocumentAsync(@NotNull Document document) {
        loadFromJsonDocument(document);
        return CompletableFuture.completedFuture(null);
    }

    @Override
    public @NotNull CompletableFuture<@NotNull Document> storeToJsonDocumentAsync() {
