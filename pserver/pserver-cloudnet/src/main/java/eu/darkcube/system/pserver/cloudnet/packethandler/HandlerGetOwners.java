...
import eu.darkcube.system.pserver.common.packets.PacketNodeWrapperOwners;
import eu.darkcube.system.pserver.common.packets.PacketWrapperNodeGetOwners;
...
public class HandlerGetOwners implements PacketHandler<PacketWrapperNodeGetOwners> {
	...
	public Packet handle(PacketWrapperNodeGetOwners packet) {
		return new PacketNodeWrapperOwners(
				DatabaseProvider.get("pserver").cast(PServerDatabase.class)
						.getOwners(packet.getPServer()));
	}
}
