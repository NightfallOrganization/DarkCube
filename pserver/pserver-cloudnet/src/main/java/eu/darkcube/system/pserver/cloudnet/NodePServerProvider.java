...
public class NodePServerProvider extends PServerProvider {
	...
	public ConcurrentMap<UniqueId, NodePServerExecutor> pservers = new ConcurrentHashMap<>();
	...
	//	}
	//
	//	private void sendUpdate(NodePServerExecutor pserver) {
	...
	//	}
	//
	//	private NodePServerExecutor newPServer(PServerSerializable s, JsonDocument data) {
	...
	//		return new NodePServerExecutor(s.id, s.temporary, s.serverName, s.taskName, conf, data);
	//	}
	//
	...
	//
	//	@Override
	//	public PServerExecutor getCurrentPServer() throws IllegalStateException {
	//		throw new IllegalStateException();
	//	}
	//
	//	@Override
	//	public NodePServerExecutor getPServer(UniqueId uuid) {
	...
	//
	//	@Override
	//	public NodePServerExecutor createPServer(PServerSerializable configuration) {
	...
	//		}
	//		NodePServerExecutor pserver =
	//				this.newPServer(configuration, getPServerData(configuration.id));
	//		this.addOrUpdate(pserver);
	//		return pserver;
	//	}
	//
	//	@Override
	//	public Optional<NodePServerExecutor> getPServerOptional(UniqueId uuid) {
	//		return Optional.ofNullable(this.getPServer(uuid));
	//	}
	//
	//	@Override
	//	public Collection<NodePServerExecutor> getPServers() {
	...
	//				this.pservers.values().stream().map(PServerExecutor::getServerName)
	//						.collect(Collectors.toList());
