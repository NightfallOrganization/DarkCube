...
import eu.darkcube.system.aetheria.manager.monster.*;
...
public class Aetheria extends DarkCubePlugin {
    ...
    @Override public void onEnable() {
        ...
        var monsterCreationManager = new MonsterCreationManager();
        monsterCreationManager.createMultipleMonsters();
        var monsterLevelManager = new MonsterLevelManager(healthManager, maxHealthManager, levelManager, damageManager, monsterCreationManager);
