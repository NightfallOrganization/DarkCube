...
public class AroundDamageCommands implements CommandExecutor {
    ...
    public AroundDamageCommands(Aetheria plugin) {
    ...
    @Override public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase("addarounddamage")) {// 28
            if (args.length == 2) {// 29
                ...
                if (target != null) {// 31
                    try {
                        ...
                        double currentDamage = dataContainer.getOrDefault(this.aroundDamageKey, PersistentDataType.DOUBLE, 0.0);// 35
            ...
            if (sender instanceof Player) {// 49
                ...
                double currentDamage = dataContainer.getOrDefault(this.aroundDamageKey, PersistentDataType.DOUBLE, 0.0);// 52
