...
public class CustomItemManager {
    ...
    public static ItemStack getRingOfSpeed() {
        ...
        if (meta != null) {
            ...
            meta.addAttributeModifier(Attribute.GENERIC_MOVEMENT_SPEED, new AttributeModifier(UUID.randomUUID(), "generic.movementSpeed", 1, AttributeModifier.Operation.MULTIPLY_SCALAR_1));
    ...
    public static ItemStack getSwiftSword() {
        ...
        if (meta != null) {
            ...
            meta.addAttributeModifier(Attribute.GENERIC_ATTACK_SPEED, new AttributeModifier("generic.attackspeed", 50.0, AttributeModifier.Operation.MULTIPLY_SCALAR_1));
            meta.addAttributeModifier(Attribute.GENERIC_ATTACK_DAMAGE, new AttributeModifier(UUID.randomUUID(), "generic.attackDamage", 2000.0, AttributeModifier.Operation.ADD_NUMBER));
            meta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
