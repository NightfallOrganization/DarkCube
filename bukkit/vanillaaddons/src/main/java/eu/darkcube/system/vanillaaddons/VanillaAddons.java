...
public class VanillaAddons extends DarkCubePlugin {
    ...
    @Override public void onLoad() {
        try {
            ...
            Language.GERMAN.registerLookup(getClass().getClassLoader(), "messages_de.properties", keyModifier);
            Language.ENGLISH.registerLookup(getClass().getClassLoader(), "messages_en.properties", keyModifier);
        } catch (IOException e) {
