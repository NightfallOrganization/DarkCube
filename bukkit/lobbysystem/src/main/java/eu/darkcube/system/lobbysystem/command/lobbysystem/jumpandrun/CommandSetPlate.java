...
public class CommandSetPlate extends LobbyCommand {
    ...
    private static int setPlate(CommandContext<CommandSource> context, ILocationArgument location, ILocationArgument rotation, boolean makenice) {
        ...
        context.getSource().sendMessage(Component.text("Dieser Block is keine Druckplatte!").color(NamedTextColor.RED));
        return 0;
    }
