...
public class CommandBuild extends LobbyCommandExecutor {
    ...
    private static int toggle(CommandContext<CommandSource> ctx, Collection<Player> players) throws CommandSyntaxException {
        for (Player t : players) {
            LobbyUser user = UserWrapper.fromUser(UserAPI.instance().user(t.getUniqueId()));
            if (user.isBuildMode()) {
                ...
                if (!ctx.getSource().assertIsEntity().equals(t)) {
                    ctx
                            ...
                            .sendMessage(Component
                                    ...
                                    .append(Component.text(" ist nun nicht mehr im ").color(NamedTextColor.RED))
                                    .append(Component.text("Bau-Modus").color(NamedTextColor.YELLOW))
                ...
                if (!ctx.getSource().assertIsEntity().equals(t)) {
                    ctx
                            ...
                            .sendMessage(Component
                                    .text(t.getName())
                                    .color(NamedTextColor.GOLD)
                                    .append(Component.text(" ist nun im ").color(NamedTextColor.GREEN))
                                    .append(Component.text("Bau-Modus").color(NamedTextColor.YELLOW))
