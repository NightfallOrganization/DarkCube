...
public enum ParticleEffect {
     ...
     */
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, Collection<? extends Player> players) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        if (this.isUnsupported()) {
            throw new ParticleVersionException("This particle effect is not supported by your server version");
        }
        if (this.hasProperty(ParticleProperty.REQUIRES_DATA)) {
     ...
     * @see ParticlePacket#sendTo(Location, Collection)
     */
    public void display(ParticleColor color, Location center, Collection<? extends Player> players) throws ParticleVersionException, ParticleColorException {
        if (this.isUnsupported()) {
            throw new ParticleVersionException("This particle effect is not supported by your server version");
        }
        if (!this.hasProperty(ParticleProperty.COLORABLE)) {
     ...
     * @see ParticlePacket#sendTo(Location, Collection)
     */
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, Collection<? extends Player> players) throws ParticleVersionException, ParticleDataException {
        if (this.isUnsupported()) {
            throw new ParticleVersionException("This particle effect is not supported by your server version");
        }
        if (!this.hasProperty(ParticleProperty.REQUIRES_DATA)) {
     ...
     * @see ParticlePacket#sendTo(Location, Collection)
     */
    public void display(ParticleData data, Vector direction, float speed, Location center, Collection<? extends Player> players) throws ParticleVersionException, ParticleDataException {
        if (this.isUnsupported()) {
            throw new ParticleVersionException("This particle effect is not supported by your server version");
        }
        if (!this.hasProperty(ParticleProperty.REQUIRES_DATA)) {
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                Class<?> packetClass = PackageType.MINECRAFT_SERVER.getClass(ParticlePacket.version < 7 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
