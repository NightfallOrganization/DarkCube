...
public class InventoryLoading extends LobbyAsyncPagedInventory {
	...
	private static final int[] MAP =
			new int[] {IInventory.slot(2, 4), IInventory.slot(2, 5), IInventory.slot(2, 6),
					IInventory.slot(3, 6), IInventory.slot(4, 6), IInventory.slot(4, 5),
					IInventory.slot(4, 4), IInventory.slot(3, 4)};
	...
	public InventoryLoading(Component title, User user,
