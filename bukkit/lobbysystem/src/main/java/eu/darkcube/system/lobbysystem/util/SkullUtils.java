...
public class SkullUtils {
    ...
    private static final Constructor<?> PROPERTY_NEW = ReflectionUtils.getConstructor(SkullUtils.PROPERTY, String.class, String.class);

    private static final Class<?> PROPERTY_MAP = ReflectionUtils.getClass("com.mojang.authlib.properties.PropertyMap");

    private static final Constructor<?> GAME_PROFILE_NEW = ReflectionUtils.getConstructor(SkullUtils.GAME_PROFILE, UUID.class, String.class);

    private static final Method GET_PROPERTIES = ReflectionUtils.getMethod(SkullUtils.GAME_PROFILE, "getProperties");

    private static final Method PUT = ReflectionUtils.getMethod(SkullUtils.PROPERTY_MAP, "put", Object.class, Object.class);

    public static void setSkullTextureId(ItemStack skull, String textureValue) {
