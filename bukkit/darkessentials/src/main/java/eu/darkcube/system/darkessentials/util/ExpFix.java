...
public class ExpFix {
	...
	/*
	 * This class is a straight copy from essentials source code. Bukkits exp part
	...
	public static void setTotalExperience(final Player player, final int exp) {
		...
		// This following code is technically redundant now, as bukkit now calulcates
		// levels more or less correctly
		// At larger numbers however... player.getExp(3000), only seems to give 2999,
		// putting the below calculations off.
		int amount = exp;
		while (amount > 0) {
