...
public class CommandMStats extends Command {

    public CommandMStats() {
        super(StatsPlugin.getInstance(), "mstats", new Command[0], "Zeigt die Monatlichen Statistiken eines Spielers an", new Argument("Spieler", "Der Spieler"));
    }
    ...
    @Override public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (user != null) {
                Stats stats = user.getLastStats(Duration.MONTH);
