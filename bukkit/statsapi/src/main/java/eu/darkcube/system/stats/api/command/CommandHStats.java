...
public class CommandHStats extends Command {

    public CommandHStats() {
        super(StatsPlugin.getInstance(), "hstats", new Command[0], "Zeigt die Stündlichen Statistiken eines Spielers an", new Argument("Spieler", "Der Spieler"));
    }
    ...
    @Override public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (user != null) {
                Stats stats = user.getLastStats(Duration.HOUR);
