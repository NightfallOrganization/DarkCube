...
public class SkylandGeneratorCommand extends CommandExecutor {
	...
	public static void deleteWorld(World world, Audience target) {
		...
		if (Bukkit.unloadWorld(world, false)) {
			...
			target.sendMessage(
					Component.text("Welt konnte nicht gelöscht werden!").color(NamedTextColor.RED));
		}
	}
