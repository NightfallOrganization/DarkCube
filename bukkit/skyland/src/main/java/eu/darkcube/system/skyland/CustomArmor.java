...
public final class CustomArmor {
    ...
    public static ItemStack getStarterSwordItem() {
        ...
        meta.addAttributeModifier(Attribute.GENERIC_ATTACK_DAMAGE,
                new AttributeModifier("generic.attackdamage",
                        10.0, AttributeModifier.Operation.MULTIPLY_SCALAR_1));
        meta.addAttributeModifier(Attribute.GENERIC_ATTACK_SPEED,
                new AttributeModifier("generic.attackspeed",
                        50.0, AttributeModifier.Operation.MULTIPLY_SCALAR_1));
