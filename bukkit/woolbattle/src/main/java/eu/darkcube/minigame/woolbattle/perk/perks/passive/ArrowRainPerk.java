...
public class ArrowRainPerk extends Perk {
	...
	public ArrowRainPerk() {
		super(ActivationType.PASSIVE, ARROW_RAIN, new Cooldown(Unit.ACTIVATIONS, 6), false, 0,
				CostType.PER_ACTIVATION, Item.PERK_ARROW_RAIN,
	...
	private static class ArrowRainListener implements Listener {
		...
		private void shootArrows(WBUser user, @SuppressWarnings("SameParameterValue") float angle,
				int count, Arrow original) {
