...
public class CommandWoolBattle extends Command {
	...
	public CommandWoolBattle() {
		super(Main.getInstance(), "woolbattle",
				new Command[] { new CommandTeam(), new CommandCreateTeam(), new CommandDeleteTeam(),
						new CommandListTeams(), new CommandCreateMap(), new CommandDeleteMap(), new CommandMap(),
						new CommandListMaps() },
