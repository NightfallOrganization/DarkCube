...
public enum CustomItemNames implements BaseMessage {
    ...
    ITEM_NAME_WHITE_WOOL_CRYSTAL,
    ITEM_NAME_WHITE_WOOL_STAR,
    ...
    GADGET_WOOLGRENADE,
    ITEM_SHEARS,
    ITEM_NAME_RED_WOOL_CRYSTAL,
    ITEM_NAME_RED_WOOL_STAR,
    ITEM_NAME_MAGENTA_WOOL_CRYSTAL,
    ITEM_NAME_MAGENTA_WOOL_STAR,
    ITEM_NAME_BROWN_WOOL_CRYSTAL,
    ITEM_NAME_BROWN_WOOL_STAR,
    ITEM_NAME_GREEN_WOOL_CRYSTAL,
    ITEM_NAME_GREEN_WOOL_STAR,
    ITEM_NAME_ORANGE_WOOL_CRYSTAL,
    ITEM_NAME_ORANGE_WOOL_STAR,
    ITEM_NAME_LIGHT_BLUE_WOOL_CRYSTAL,
    ITEM_NAME_LIGHT_BLUE_WOOL_STAR,
    ITEM_NAME_YELLOW_WOOL_CRYSTAL,
    ITEM_NAME_YELLOW_WOOL_STAR,
    ITEM_NAME_GRAY_WOOL_CRYSTAL,
    ITEM_NAME_GRAY_WOOL_STAR,
    ITEM_NAME_LIME_WOOL_CRYSTAL,
    ITEM_NAME_LIME_WOOL_STAR,
