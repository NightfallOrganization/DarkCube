...
public final class ReflectionUtils {
	 ...
	 * @throws NoSuchMethodException  If the desired constructor with the specified
	 *                                parameter types cannot be found
	 * @throws ClassNotFoundException ClassNotFoundException If the desired target
	 *                                class with the specified name and package
	 *                                cannot be found
	 ...
	 *                                class with the specified name and parameter
	 *                                types cannot be found
	 * @throws ClassNotFoundException If the desired target class with the specified
	 *                                name and package cannot be found
	 * @see #getClass(String, PackageType)
	 ...
	 *                                   the target object
	 * @throws NoSuchMethodException     If the desired method of the desired target
	 *                                   class with the specified name and arguments
	 *                                   cannot be found
	...
	public static Object getValue(Object instance, String className, boolean declared, String fieldName) {
