...
public enum Direction {
	...
	private Direction(int indexIn, int oppositeIn, int horizontalIndexIn, String nameIn,
			AxisDirection axisDirectionIn, Axis axisIn, Vector3i directionVecIn) {
		this.index = indexIn;
	...
	public static enum Axis implements Predicate<Direction> {
		...
		private static final Map<String, Axis> NAME_LOOKUP = Arrays.stream(Axis.VALUES)
				.collect(Collectors.toMap(Axis::getName2, (p_199785_0_) -> {
					return p_199785_0_;
				}));
		private final String name;
