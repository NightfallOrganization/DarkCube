...
public class LobbyRuler implements Listener {
    ...
    public LobbyRuler() {
        ...
        Bukkit.getScheduler().runTaskTimer(Sumo.getPlugin(Sumo.class), () -> {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        Location lobbyLocation = new Location(event.getPlayer().getWorld(), 0.5, 101, 0.5);
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        if (event.getPlayer().getWorld().getName().equals("world")) {
            if (event.getPlayer().getLocation().getY() < 80) {
                Location newLocation = new Location(event.getPlayer().getWorld(), 0.5, 101, 0.5);
