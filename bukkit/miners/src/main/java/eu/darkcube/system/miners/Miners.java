...
public class Miners extends DarkCubePlugin {
	...
	public static final String PREFIX =
			ChatColor.GRAY + "[" + ChatColor.DARK_AQUA + "Miners"
	...
	public static void sendTranslatedMessageAll(Message message, Object... replacements) {
		...
		AdventureSupport.audienceProvider().console()
				.sendMessage(message.getServerMessage(replacements));
	}
	...
	public void onEnable() {
		...
		registerListeners(new ListenerPlayerQuit(), new ListenerPlayerLogin(),
				...
				new ListenerItemInteract(), new ListenerPlayerDeath(), new ListenerPlayerDamage(),
				new ListenerChatMessage());
