...
public class Miners extends DarkCubePlugin {
    ...
    public static void sendTranslatedMessageAll(Message message, Object... replacements) {
        ...
        AdventureSupport.audienceProvider().sender(Bukkit.getConsoleSender()).sendMessage(message.getMessage(Bukkit.getConsoleSender(), replacements));
    }
    ...
    public void onEnable() {
        ...
        registerListeners(new ListenerPlayerQuit(), new ListenerPlayerLogin(), new ListenerPlayerJoin(), new ListenerBlockBreak(), new ListenerPlaceBlock(),
                new ListenerItemInteract(), new ListenerPlayerDamage(), new ListenerChatMessage(), new ListenerCrafting(), new ListenerItemPickup(), new ListenerSpectators());
