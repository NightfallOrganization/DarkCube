...
public class SettingsHeightDisplayInventory extends WoolBattlePagedInventory {
    ...
    protected void fillItems(Map<Integer, ItemStack> items) {
        ...
        fallbackItems.put(IInventory.slot(3, 6), (user.heightDisplay().isEnabled() ? Item.HEIGHT_DISPLAY_ON : Item.HEIGHT_DISPLAY_OFF).getItem(user));
    ...
    protected void inventoryClick(IInventoryClickEvent event) {
        ...
        } else if (itemId.equals(Item.HEIGHT_DISPLAY_OFF.getItemId()) || itemId.equals(Item.HEIGHT_DISPLAY_ON.getItemId())) {
