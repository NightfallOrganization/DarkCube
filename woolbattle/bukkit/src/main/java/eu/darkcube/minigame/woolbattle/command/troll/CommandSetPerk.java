        ...
        super("setPerk", b -> {
            ...
            for (ActivationType type : ActivationType.values()) {
                ...
                b2.then(Commands
                        ...
                        .then(Commands
                                .argument("perkSlot", IntegerArgumentType.integer(1, type.maxCount()))
                                .then(Commands.argument("perk", PerkArgument.singlePerkArgument(perkList::contains, woolbattle)).executes(ctx -> {
                                    ...
                                    for (Player player : targetPlayers) {
                                        ...
                                        ctx
                                                .getSource()
                                                .sendMessage(Message.PERK_SET_FOR_PLAYER, type
                                                        .name()
                                                        .toLowerCase(), perkSlot + 1, user.getTeamPlayerName(), perk
                                                        .perkName()
                                                        .getName()
                                                        .toLowerCase());
                                    }
