...
public class ArrowBombPerk2 extends Perk {
    public static final PerkName ARROW_BOMB = new PerkName("ARROW_BOMB_2");

    public ArrowBombPerk2(@NotNull Game game) {
        super(ActivationType.ACTIVE, ARROW_BOMB, 9, 7, Items.PREV_PAGE_UNUSABLE.withoutId(), (user, perk, id, perkSlot, g) -> new CooldownUserPerk(user, id, perkSlot, perk, Items.PREV_PAGE_UNUSABLE.withoutId(), g));
