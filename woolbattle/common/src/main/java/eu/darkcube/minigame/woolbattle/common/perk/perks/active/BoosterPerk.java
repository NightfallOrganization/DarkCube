...
public class BoosterPerk extends Perk {
    ...
    public BoosterPerk(CommonGame game) {
        super(ActivationType.ACTIVE, BOOSTER, 18, 12, Items.PERK_BOOSTER, (user, perk, id, perkSlot, g) -> new CooldownUserPerk(user, id, perkSlot, perk, Items.PERK_BOOSTER_COOLDOWN, g));
    }
}
