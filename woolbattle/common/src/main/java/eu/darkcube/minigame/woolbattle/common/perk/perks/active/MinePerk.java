...
public class MinePerk extends Perk {
    ...
    public MinePerk(CommonGame game) {
        super(ActivationType.ACTIVE, MINE, 6, 7, Items.PERK_MINE, (user, perk, id, perkSlot, g) -> new CooldownUserPerk(user, id, perkSlot, perk, Items.PERK_MINE_COOLDOWN, g));
    }
}
