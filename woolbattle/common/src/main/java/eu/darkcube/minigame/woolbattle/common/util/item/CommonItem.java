...
public interface CommonItem extends Item {
    @Override default ItemBuilder getItem(WBUser user) {
        return ItemManager.instance().getItem(this, user);
    }

    @Override default ItemBuilder getItem(WBUser user, Object... replacements) {
        return ItemManager.instance().getItem(this, user, replacements);
    }

    @Override default ItemBuilder getItem(WBUser user, Object[] replacements, Object... loreReplacements) {
        return ItemManager.instance().getItem(this, user, replacements, loreReplacements);
    }

    @Override default String itemId() {
